---
name: start-ralphy-plan
description: Use when beginning design process for ralphy workflow - orchestrates context gathering, clarification, brainstorming, and creates ralphy-compatible PRD with design context and detailed task lists
---

# Starting a Ralphy Plan

## Overview

Orchestrate complete design workflow from initial idea to ralphy-ready PRD through six structured phases: context gathering, clarification, definition of done, brainstorming, PRD documentation, and ralphy handoff.

**Core principle:** Progressive information gathering → clear understanding → creative exploration → validated design → ralphy-compatible PRD.

**Announce at start:** "I'm using the start-ralphy-plan skill to guide us through the design process and create a ralphy-compatible PRD."

## Quick Reference

| Phase | Key Activities | Output |
|-------|---------------|--------|
| **1. Context Gathering** | Ask for description, constraints, goals, URLs, files | Initial context bundle |
| **2. Clarification** | Invoke asking-clarifying-questions skill | Disambiguated requirements |
| **3. Definition of Done** | Synthesize and confirm deliverables | Confirmed success criteria |
| **4. Brainstorming** | Invoke brainstorming skill | Validated design |
| **5. PRD Documentation** | Invoke writing-ralphy-prds skill | Committed ralphy-compatible PRD |
| **6. Ralphy Handoff** | Provide ralphy execution command | Ready to execute |
...
- Phase 5: PRD Documentation (ralphy PRD written to docs/design-plans/)
- Phase 6: Ralphy Handoff (execution command provided)
...
"I need some information to start the design process for your ralphy PRD. Please provide what you have:
...
### Phase 5: PRD Documentation

Create ralphy-compatible PRD with design context and detailed task list.

Use TaskUpdate to mark Phase 5 as in_progress.

**REQUIRED SUB-SKILL:** Use ralphy-planning:writing-ralphy-prds

Announce: "I'm using the writing-ralphy-prds skill to create your ralphy-compatible PRD."

The writing-ralphy-prds skill will:
- Create file at `docs/design-plans/YYYY-MM-DD-<topic>.md`
- Write Summary, Architecture, Existing Patterns sections
- Document Definition of Done
- Generate detailed task list grouped by dependency
- Include Additional Considerations (security, performance, etc.)
- Generate Glossary
- Commit to git

**Output:** Committed ralphy-compatible PRD ready for execution.

Mark Phase 5 as completed when PRD is committed.

### Phase 6: Ralphy Handoff

After PRD is documented, provide ralphy execution command.

Use TaskUpdate to mark Phase 6 as in_progress.

**Announce PRD completion and provide execution command:**

```
PRD complete! Committed to `docs/design-plans/YYYY-MM-DD-<topic>.md`

Ready to execute with ralphy:
...
- Track completion in the PRD file

You can monitor progress by checking the PRD file - ralphy marks completed tasks with [x].
```

**Why ralphy instead of manual execution:**
- Agents work in isolation (no context pollution)
- Automatic task orchestration
- Built-in merge handling
- Progress tracking in PRD file
...
- PRD documentation reveals missing details → Return to Phase 4
...
| "Design is in conversation, don't need PRD" | PRD is contract with ralphy. Always run Phase 5. |
| "Can skip ralphy handoff instructions" | User needs execution command. Provide clear instructions. |
...
| **Task tracking** | Create todos with TaskCreate and update with TaskUpdate for all phases |
| **Flexible progression** | Go backward when needed to fill gaps |
| **Ralphy-ready output** | PRD works directly with `./ralphy.sh --prd` |
